...
describe('RecordService', () => {
  ...
  describe('create()', () => {
    it('creates and returns a Record', () => {
      ...
      service.create(collectionId, params).then((res) => {
        expect(res).toEqual(jasmine.any(Record));
        expect(res._id).toBeDefined();
        expect(res.properties.name).toEqual(params.properties.name);
      });

      const req = httpMock.expectOne(`${service.basePath}/${collectionId}/records`);
  ...
  describe('delete()', () => {
    it('deletes the Record and returns true', () => {
      ...
      service.delete(collectionId, _id).then((res) => {
        expect(res).toBeTruthy();
      });

      const req = httpMock.expectOne(`${service.basePath}/${collectionId}/records/${_id}`);
  ...
  describe('find()', () => {
    it('returns an array of Records', () => {
      ...
      service.find(collectionId, params).then((res) => {
      ...
      const req = httpMock.expectOne(
        (r) => r.url === `${service.basePath}/${collectionId}/records`,
      );
  ...
  describe('findOne()', () => {
    it('returns a Record', () => {
      ...
      service.findOne(collectionId, _id).then((res) => {
        expect(res).toEqual(jasmine.any(Record));
  ...
  describe('update()', () => {
    it('updates and returns a Record', () => {
      ...
      service.update(collectionId, params).then((res) => {
        expect(res).toEqual(jasmine.any(Record));
        expect(res._id).toEqual(params._id);
        expect(res.properties.name).toEqual(params.properties.name);
      });

      const req = httpMock.expectOne(`${service.basePath}/${collectionId}/records/${params._id}`);
