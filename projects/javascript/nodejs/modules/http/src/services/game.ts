...
export class GameService {
  public emitter = new ServiceEventEmitter<GameModel>();
  private baseService = new BaseService<GameModel>(this.emitter, GameModel);
   ...
   * Creates a Record.
   */
  public async create(json: Partial<GameModel>) {
    const url = this.getUrl();
   ...
   * Updates a Record.
   */
  public async update(_id: string, json: Partial<GameModel>) {
    const url = this.getUrl();
