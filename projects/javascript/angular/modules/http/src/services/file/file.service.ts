...
export class FileService {
  ...
  public async delete(buildId: string, platform: string, _id: string): Promise<File> {
    const response = await this.apiService.request(
      'delete',
      `${this.basePath}/${buildId}/platforms/${platform}/files/${_id}`,
    );
  ...
  public download(buildId: string, platform: string, parameters: FileServiceDownloadOptions) {
    return this.apiService.request(
      'post',
      `${this.basePath}/${buildId}/platforms/${platform}/files/download`,
      parameters,
  ...
  public async find(
    ...
    const response = await this.apiService.request(
      'get',
      `${this.basePath}/${buildId}/platforms/${platform}/files`,
      parameters,
    );
  ...
  public async findOne(buildId: string, platform: string, _id: string): Promise<File> {
    const response = await this.apiService.request(
      'get',
      `${this.basePath}/${buildId}/platforms/${platform}/files/${_id}`,
    );
  ...
  public upload(buildId: string, platform: string, parameters: FileServiceUploadOptions) {
    const formData = new FormData();

    parameters.modified.forEach(m => formData.append('modified[]', m));
    formData.append('previousBuildId', parameters.previousBuildId);
    ...
    return this.apiService.request(
      'post',
      `${this.basePath}/${buildId}/platforms/${platform}/files/upload`,
      formData,
