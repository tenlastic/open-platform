...
export class StorefrontService {
  ...
  private baseService = new BaseService<StorefrontModel>(this.emitter, StorefrontModel);
   ...
   * Creates a Record.
   */
  public async create(json: Partial<StorefrontModel>) {
    const url = this.getUrl();
   ...
   * Updates a Record.
   */
  public async update(_id: string, json: Partial<StorefrontModel>) {
    const url = this.getUrl();
