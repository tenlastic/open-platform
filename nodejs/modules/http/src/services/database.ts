...
export class DatabaseService {
  public emitter = new ServiceEventEmitter<DatabaseModel>();
  private baseService = new BaseService<DatabaseModel>(this.emitter, DatabaseModel);
   ...
   * Creates a Record.
   */
  public async create(json: Partial<DatabaseModel>) {
    const url = this.getUrl();
   ...
   * Updates a Record.
   */
  public async update(_id: string, json: Partial<DatabaseModel>) {
    const url = this.getUrl();
